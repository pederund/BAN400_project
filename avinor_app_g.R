...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(titlePanel("Avinor flight traffic"),style = "color:#84216b;position:right;350px",
              tabsetPanel(
                id = 'dataset',
                tabPanel("Departure", dataTableOutput("table1")),
                tabPanel("Arrival", dataTableOutput("table2"))),
